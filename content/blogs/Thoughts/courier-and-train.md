...
But...indeed there is something different this time. 

## Is it really that different

The reassuring reading of the courier story holds exactly as far as that stays true --- as far as the machine is a complement. The trouble is that AI is not cleanly one thing. On some tasks it complements you, the way the truck complemented the driver. On others it substitutes for you outright, doing the whole task end to end with no human in the loop. And the substitute fraction is larger, and growing faster, than it ever was for trains and trucks. The driver felt safe right up until the self-driving truck arrived, at which point he stopped being a complement and became a cost. The courier analogy quietly assumes the machine stays in the helpful-tool role.

What rescued workers each previous time was human cognitive flexibility: the machine took the task, and the human climbed to the next rung: the one requiring judgment, dexterity, or thought the machine could not reach. The escape worked because there was always a higher cognitive rung, and only humans could stand on it.
...
Notice that everything above is about the size of the pie and the shape of the remaining work. None of it tells you WHO gets to eat how much. That is a separate question, and it is the one the courier story has no answer for, because the answer was never technological.
